...
<head>
  ...
  <title>Modiier Prospection</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Modifier Prospection</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">Modifier Prospection</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    ?>  
      ...
      <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
        ...
        <?php 
              ...
              // Taking all 5 values from the form data(input)
            $ID_Pr =  $_POST['ID_PR'];
          $resultPrPos=mysqli_query($con, "SELECT  pri.`ID_PI`, pri.`Nom_PI`, pri.`Prenom_PI`, pri.`Tel_PI`, pri.`Email_PI`, pri.`Fonction_PI` FROM `personne_interviewe` pri,`entreprise` e,`prospection` p WHERE p.ID_E=e.ID_E AND e.ID_E=pri.ID_E AND p.`ID_Pr`='$ID_Pr'")or die('Error In Session');
        ...
        <li class="text-sm">Nom & Prénom
          ...
          <li class="text-sm">Fonction ddu prospect
